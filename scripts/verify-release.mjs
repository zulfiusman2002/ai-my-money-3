...
if (pkg.version !== '1.0.0') throw new Error(`Expected package version 1.0.0, got ${pkg.version}`);
...
console.log('✓ MoneyMilo 1.0 release structure and secret checks passed.');
