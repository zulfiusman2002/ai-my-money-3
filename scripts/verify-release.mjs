...
if (pkg.version !== '2.1.0') throw new Error(`Expected package version 2.1.0, got ${pkg.version}`);
...
console.log('✓ MoneyMilo 2.1 release structure and secret checks passed.');
