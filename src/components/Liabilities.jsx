...
export default function Liabilities({ rows, onChanged }) {
  ...
  return (
    <div className="card">
      ...
      {form && (
        <div className="rise" style={{ border: '1px solid var(--c-border)', borderRadius: 12, padding: 14, marginBottom: 12, display: 'grid', gap: 10 }}>
      ...
      {rows.map((l) => (
        <div key={l.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '9px 0', borderBottom: '1px solid var(--c-border)', gap: 8 }}>
