    ...
    <div className="auth-shell">
      ...
      <div className="auth-left">
        <div style={{ marginBottom: 40 }}>
          <div style={{ fontWeight: 700, fontSize: '1.2rem', color: 'var(--c-ink)', marginBottom: 48 }}>
            Money<span style={{ color: '#C88B08' }}>Milo</span>
          </div>
          <h2 style={{ fontSize: 'clamp(1.6rem,4vw,2.2rem)', fontWeight: 700, color: 'var(--c-ink)', letterSpacing: '-.025em', lineHeight: 1.15, marginBottom: 16 }}>
            Your financial<br />command centre.
          </h2>
          <p style={{ color: 'var(--c-muted)', fontSize: '.9375rem', lineHeight: 1.65 }}>
            Every pound accounted for. Every goal tracked.<br />AI working from your real numbers.
          </p>
        </div>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          {['Budget · Investments · Goals', 'Net Worth · Projector · Ask Milo', 'Learn — finance that sticks'].map((t) => (
            <div key={t} style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <div style={{ width: 20, height: 20, borderRadius: '50%', background: 'rgba(118,87,245,.12)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <div style={{ width: 7, height: 7, borderRadius: '50%', background: '#7657F5' }} />
              </div>
              <span style={{ color: 'var(--c-ink2)', fontSize: '.9rem' }}>{t}</span>
            </div>
          ))}
        </div>
      </div>
