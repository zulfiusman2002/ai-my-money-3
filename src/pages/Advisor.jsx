...
function answerToContext(answer) {
  if (!answer || typeof answer === 'string') return String(answer || '');
...
export default function Advisor(){
  ...
  return <div className="page page-wide advisor-v1 advisor-v11">
    ...
    <div className="advisor-trust-strip-v1"><span><Icon name="check" size={15}/>Uses your recorded MoneyMilo data</span><span><Icon name="spark" size={15}/>Shows assumptions and missing information</span><span><Icon name="shield" size={15}/>Educational guidance, not regulated advice</span></div>
    ...
    <div className="advisor-layout">
      ...
      <main className="advisor-main">
        ...
        <section className="chat-panel chat-panel-v1 chat-panel-v11">
          ...
          <div className="chat-compose-note-v11"><span>Enter to send · Shift + Enter for a new line</span><span>MoneyMilo 1.1 AI Experience</span></div>
