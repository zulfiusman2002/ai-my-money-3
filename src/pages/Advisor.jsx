...
export default function Advisor(){
  ...
  return <div className="page page-wide">
    ...
    <MiloCoach mode="ai" eyebrow="AI Milo · connected intelligence"
      ...
      body="Budget, goals, investments, property, liabilities and learning can all change the answer. Milo brings those modules together and shows the numbers behind the response."
      facts={[
    ...
    <div className="advisor-layout">
      <aside className="advisor-side">
        <div className="advisor-profile"><MiloAvatar mode="ai" size={170} motion="idle" glow/><div><h2>AI Milo</h2><p>Your private money co-pilot. Educational guidance, grounded in your data.</p></div></div>
      ...
      <main className="advisor-main">
        ...
        {!analysis&&!busyType&&<section className="milo-greeting milo-mint" style={{marginBottom:16,minHeight:190}}><div className="milo-greeting-copy"><div className="milo-eyebrow"><Icon name="spark" size={15}/>Start with a focused review</div><h2>What would you like Milo to look at?</h2><p>Choose a review on the left, or ask a specific question below. Short, focused questions usually produce the clearest answer.</p></div><MiloAvatar mode="ai" size={170} motion="wave" glow/></section>}
