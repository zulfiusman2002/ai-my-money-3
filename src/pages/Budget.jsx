  ...
  return (
    <div className="page page-wide">
      ...
      <MiloCoach mode="builder" eyebrow="Builder Milo · monthly foundations"
        ...
        body={totals.net >= 0 ? 'I’ve separated income, spending and allocations so you can see exactly what is available before committing it.' : 'Let’s repair the plan by checking the largest categories first — without judging the spending that matters to you.'}
        facts={[
