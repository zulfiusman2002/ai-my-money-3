    ...
    <div className="page page-wide dashboard-v3">
      ...
      <section className="dashboard-bento fade-up">
        ...
        <article className="hero-wealth-v3">
          ...
          <div className="chart-legend-v41" aria-label="Chart legend">
            <span><i style={{background:'#7657F5'}}/>Net worth</span>
            <span><i style={{background:'#47C9AA'}}/>Total assets</span>
            <small>Hover or tap a point to see the month and exact value.</small>
          </div>
