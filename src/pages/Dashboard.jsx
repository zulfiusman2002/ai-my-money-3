...
export default function Dashboard() {
  ...
  const moneyPulse = Math.round(savingsScore + liquidityScore + debtScore + goalScore);
      ...
      <section className="dashboard-overview-grid-v42 fade-up">
        ...
        <aside className="pulse-card-v42">
          ...
          <div className="pulse-breakdown-v42">
            <div><span>Cash flow</span><strong>{Math.round(savingsScore)}/35</strong></div>
            <div><span>Liquidity</span><strong>{Math.round(liquidityScore)}/25</strong></div>
            <div><span>Debt</span><strong>{Math.round(debtScore)}/25</strong></div>
            <div><span>Goal system</span><strong>{Math.round(goalScore)}/15</strong></div>
          </div>
