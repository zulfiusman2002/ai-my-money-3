  ...
  return (
    <div className="page page-wide dashboard-v42">
      ...
      <section className="connected-brain-v2 fade-up delay-1">
        <header><div><span className="t-label">MoneyMilo 2.0 · Connected Intelligence</span><h2>One financial brain, not separate dashboards.</h2><p>These priorities are calculated from cash flow, goals, wealth, portfolio freshness and learning together.</p></div><button className="btn btn-secondary btn-sm" onClick={()=>nav('/app/timeline')}>Open timeline <Icon name="arrow" size={15}/></button></header>
