  ...
  return (
    <div className="page page-wide learn-v3-page">
      ...
      {stage === 'ready' && lesson && <section className="next-lesson-v41 fade-up">
        ...
        <div className="next-lesson-copy-v41"><span className="academy-kicker">Continue learning</span><div className="next-lesson-badge-v41">Next lesson</div><h2>{lesson.title}</h2><p>Module {lesson.module_id} · about 5 minutes · {totalLessonSteps} short steps</p><div className="next-lesson-outline-v41"><div><b>1</b><span>Learn one clear idea</span></div><div><b>2</b><span>See it in your real money life</span></div><div><b>3</b><span>Answer one question and earn XP</span></div></div><button className="btn btn-primary btn-lg" onClick={()=>{setLessonStep(0);setStage('lesson');}}>Start this lesson <Icon name="arrow" size={18}/></button><small>Your progress is saved after the quiz.</small></div>
      </section>}
