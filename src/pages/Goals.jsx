  ...
  return (
    <div className="page page-wide">
      ...
      <MiloCoach mode="goals" eyebrow="Goals Milo · progress coach"
        ...
        body={headroom >= 0 ? 'Your goals are funded by a real monthly system, not just a target on a screen. Use the scenario controls to see what one small increase changes.' : 'We can protect the goals that matter most by adjusting contributions or improving cash flow.'}
        facts={[
