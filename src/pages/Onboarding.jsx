...
export default function Onboarding() {
  ...
  const screens = [
    // 0 Welcome
    <div key="w">
      <div style={{ fontSize: '.75rem', fontWeight: 600, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--c-gold)', marginBottom: 16 }}>MONEYMILO · SETUP</div>
      ...
      <p style={{ color: 'rgba(255,255,255,.55)', fontSize: '.9375rem', lineHeight: 1.65, marginBottom: 36 }}>MoneyMilo works best when it knows your income, expenses, investments and goals. Takes about 3 minutes.</p>
