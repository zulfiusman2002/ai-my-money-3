...
export default function Onboarding() {
  ...
  return <div className="onboarding-shell onboarding-v3 onboarding-v41">
    ...
    <section className="onboarding-main-v3">
      ...
      <div className="onboarding-question-v21"><MiloAvatar mode={interview.mode} size={78} motion="idle"/><div><span>Milo asks</span><strong>{interview.title}</strong><p>{interview.body}</p></div></div>
