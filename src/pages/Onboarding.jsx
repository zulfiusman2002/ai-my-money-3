...
export default function Onboarding() {
  ...
  const screens = [
    // 0 Welcome
    <div key="w">
      <div style={{ fontSize: '.75rem', fontWeight: 600, letterSpacing: '.1em', textTransform: 'uppercase', color: 'var(--c-gold)', marginBottom: 16 }}>MONEYMILO · YOUR PROFILE</div>
      <h1 style={{ fontSize: 'clamp(1.8rem,6vw,2.6rem)', fontWeight: 700, color: '#fff', letterSpacing: '-.025em', lineHeight: 1.12, marginBottom: 16 }}>Now let’s personalise Milo.</h1>
      <p style={{ color: 'rgba(255,255,255,.55)', fontSize: '.9375rem', lineHeight: 1.65, marginBottom: 36 }}>A few details about income, expenses, wealth and goals help Milo build a useful starting picture. You stay in control and can edit everything later.</p>
      <BtnGold onClick={next}>Start my setup →</BtnGold>
    </div>,
