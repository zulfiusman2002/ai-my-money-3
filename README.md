...
## MoneyMilo 2.0 release focus

MoneyMilo 2.0 connects the existing product modules through one deterministic financial brain.
...
MoneyMilo 2.0 requires no new migration beyond the existing adaptive-profile migration:
...
MoneyMilo 2.0 does not change or embed the Claude API key.
